			...
			<table class="exerciseForm" style="width: 75%; height: 400px;">
				<tbody>
					<tr>
						...
						<td><form:input class="newExerciseInput" path="exerciseName" type="text"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><form:input class="newExerciseInput" path="difficulty" type="number"/></td>
					</tr>
					<tr>
						<td><form:errors path="difficulty" class="errors"/></td>
					</tr>
					<tr>
						<td><form:label class="labelTitle" path="categories">Category: </form:label></td>
					...
					<tr>
						<td><button class="button">Create</button></td>
					</tr>
				</tbody>
			</table>
		</form:form>
